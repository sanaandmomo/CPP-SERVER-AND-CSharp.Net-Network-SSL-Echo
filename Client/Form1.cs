...
namespace Client
{
    public partial class Form1 : Form
    {
        ...
        private void button_Click(object sender, EventArgs e)
        {
            ...
            SslStream sslStream = new SslStream(client.GetStream(), false, validateCertifiate, null);
        ...
        private bool validateCertifiate(object sender, X509Certificate certificate, X509Chain chain, SslPolicyErrors sslPolicyErrors)
        {
            return true;
        }
    }
